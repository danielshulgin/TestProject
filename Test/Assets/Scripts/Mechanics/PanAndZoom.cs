...
public class PanAndZoom : MonoBehaviour
{
    ...
    void CameraInBounds()
    {
        if (controlCamera && useBounds && cam != null)
        {
            ...
            float camY = Mathf.Clamp(cam.transform.position.z, camMinY, camMaxY);

            cam.transform.position = new Vector3(camX, cam.transform.position.y, camY);
        }
    }
}
